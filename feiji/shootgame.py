...
# 背景图
background = pygame.image.load_basic(r'D:\Python_work\feiji\background.bmp').convert()
# self.image = pygame.image.load(r'D:\python3wp\alien_invasion\images\ship.bmp')

# Game Over 的背景图
game_over = pygame.image.load_basic('gameover.bmp')

# 飞机及子弹图片合集
plane_img = pygame.image.load_basic('shoot.bmp')
